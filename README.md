# accountModule OpenAPI Specification
[![Build Status](https://travis-ci.com/doc/repo.svg?branch=master)](https://travis-ci.com/doc/repo)
## Steps to finish
...
- [Reference Documentation (ReDoc)](https://doc.github.io/repo/)
- [SwaggerUI](https://doc.github.io/repo/swagger-ui/)
- OpenAPI Raw Files: [JSON](https://doc.github.io/repo/openapi.json) [YAML](https://doc.github.io/repo/openapi.yaml)
